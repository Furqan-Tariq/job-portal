...
import { AllJobsFilters } from "@/components/admin/all-jobs/AllJobsFilters"
import { JobList } from "@/components/admin/all-jobs/JobList"
import type { EmployerJob } from "@/components/admin/all-jobs/types"
...
async function getEmployerJobs(): Promise<EmployerJob[]> {
  try {
    ...
    const res = await fetch(`${API_BASE_URL}/admin/posted-jobs`, {
      method: "GET",
      headers: {
